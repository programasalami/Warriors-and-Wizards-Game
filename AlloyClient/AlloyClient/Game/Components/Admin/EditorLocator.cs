...
// below the repo root (AlloyClient/AlloyClient/bin/Debug/net10.0), so it walks up until it finds the tool. The zip that testers download does not contain the
