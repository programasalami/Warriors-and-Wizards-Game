...
public static class StaticProps {
    ...
    // ALLOY_NO_STATIC_BAKE=1 draws static props the old per-frame way (for A/B checks of the look and the cost).
    private static readonly bool Disabled = Environment.GetEnvironmentVariable("ALLOY_NO_STATIC_BAKE") == "1";
