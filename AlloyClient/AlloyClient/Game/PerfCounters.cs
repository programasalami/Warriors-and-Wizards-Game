...
public static class PerfCounters {
    ...
    // GPU traffic of the LAST frame (Alloy.Engine.Graphics.GpuStats counts the current one; copied here at the start of the next).
    ...
    public static void BeginFrame() {
        ...
        DrawCallsLastFrame = Alloy.Engine.Graphics.GpuStats.DrawCalls;
        UploadBytesLastFrame = Alloy.Engine.Graphics.GpuStats.UploadBytes;
        Alloy.Engine.Graphics.GpuStats.Reset();
    }
}
