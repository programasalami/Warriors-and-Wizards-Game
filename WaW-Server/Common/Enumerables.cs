...
public enum StatType {
    ...
    Unused11 = 94,
    Unused12 = 95,
    Skill0 = 96,       // the Skill slot's item type (player slot 20, InventoryLayout.SkillSlot), 2026-09-23; was Unused4
    Unused13 = 97,
    Unused14 = 98,
    MaxHPBonus = 99,
    MaxMPBonus = 100,
    ...
    Unused21 = 113,
    Unused22 = 114,
    SkillData0 = 115,  // the Skill slot's item data (a string, like InventoryData0-19), 2026-09-23; was Unused5
    Unused23 = 116,
    Unused24 = 117,
    Condition2 = 118,
    AccRank = 119,
