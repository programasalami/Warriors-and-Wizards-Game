...
// variable ALLOY_DEBUG_LOG is set (they used to print in every Debug build - 20 lines a second per player from the sight system).
public class Logger : ILogger {
    private const int PADDING = 18;
    private const int QueueCapacity = 20_000;
    public const string DebugEnvVar = "ALLOY_DEBUG_LOG";
