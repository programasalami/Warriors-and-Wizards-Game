...
rule('WaW-Client/WaWClient/Logging/Logging.cs',
...
rule('WaW-Client/WaW.Engine/Graphics/Buffers/IndexBuffer.cs',
...
rule('WaW-Client/WaWClient/AppEngine/AppEngineClient.cs',
...
replace_file('WaW-Client/WaWClient/Networking/Client.cs', 'shim/WebClient.cs')
...
rule('WaW-Client/WaWClient/Core/Settings.cs',
...
replace_file('WaW-Client/WaW.Engine/Graphics/Buffers/UniformBuffer.cs', 'shim/UniformBuffer.cs')
rule('WaW-Client/WaW.Engine/Graphics/Shader.cs',
...
replace_file('WaW-Client/WaWClient/Utils/ClientPlatform.cs', 'shim/ClientPlatform.cs')
