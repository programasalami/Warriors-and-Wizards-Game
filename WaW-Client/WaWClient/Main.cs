...
public sealed class Main() : GameWindow(new Version(4, 3), ILogger.Factory) {
    ...
    private LoadPlan BuildStartupPlan() {
        ...
        var titleLogo = plan.AddMainThread("Title logo", 6, () => titleLogoSheet = ContentLoader.LoadTexture(WaWClient.Screens.Components.TitleLogoAnimData.SheetPath));
