...
public sealed class OptionsView : Overlay {
    ...
    // Renamed 2026-09-23: "Controls" -> General (movement, camera, actions, interface keys), "Hot Keys" -> Inventory (the slot keys).
    ...
    private static readonly string[] Tabs = [GeneralTab, InventoryTab, ChatTab, GraphicsTab, SoundTab, ExtraTab];
