...
using WaW.Common;
using WaW.ContentBuilder;
using WaW.ContentBuilder.Builders;
...
#if USER_DEBUG
const string clientProjectPath = "E:\\Development\\Github\\WaW-Client\\WaWClient"; // hard path to client project (NOT the main(sln) folder)
