...
Output 1: WaW-Client/WaWClient/Content/Title/TitleMap.png - ONE image, the map (1280 x 720 = the UI design canvas, so map
...
Output 2: WaW-Client/WaWClient/Screens/Components/CaveBackdropData.g.cs - where the ambience goes (crystal glows, warm
...
OUT = 'WaW-Client/WaWClient/Content/Title/TitleMap.png'
DATA_OUT = 'WaW-Client/WaWClient/Screens/Components/CaveBackdropData.g.cs'
W, H = 1280, 720
T = 32
