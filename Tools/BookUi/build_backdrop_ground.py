...
Output: WaW-Client/WaWClient/Content/Ui/Backdrop/ForestGround.png, native 16px tiles (the UI draws it 2x).
...
SHEETS = 'WaW-Client/WaWClient/Content/Sheets'
...
OUT = 'WaW-Client/WaWClient/Content/Ui/Backdrop/ForestGround.png'
...
cs += ['    ];', '}', '']
open('WaW-Client/WaWClient/Screens/Components/CharacterList/BackdropData.g.cs', 'w', encoding='utf-8', newline=chr(10)).write(chr(10).join(cs))
