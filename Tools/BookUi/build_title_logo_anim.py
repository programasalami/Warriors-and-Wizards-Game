...
logo, scaled down and packed into one sprite sheet: AlloyClient/Content/Title/LogoSheet.png, plus the generated
AlloyClient/Screens/Components/TitleLogoAnimData.g.cs describing the grid (frame size, count, columns, aspect).
...
SHEET_OUT = 'AlloyClient/AlloyClient/Content/Title/LogoSheet.png'
DATA_OUT = 'AlloyClient/AlloyClient/Screens/Components/TitleLogoAnimData.g.cs'
