...
plus the user's tab icons, into AlloyClient/AlloyClient/Content/Ui/BookGems, and writes the frame
...
OUT = 'AlloyClient/AlloyClient/Content/Ui/BookGems'
CS_OUT = 'AlloyClient/AlloyClient/Screens/Components/CharacterList/BookFrameData.g.cs'
