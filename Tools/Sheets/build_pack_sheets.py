...
What it does (re-runnable; the packs are read, never written):
  1. Writes the new sheets into AlloyClient/AlloyClient/Content/Sheets:
  ...
  4. Writes AlloyClient/AlloyClient/Game/Components/Admin/ArtPlaceholders.g.cs: the objects whose new picture is only a stand-in, so the admin
...
PLACEHOLDERS_CS = os.path.join(ROOT, 'AlloyClient', 'AlloyClient', 'Game', 'Components', 'Admin', 'ArtPlaceholders.g.cs')
...
def write_placeholders():
    lines = ['// Generated by Tools/Sheets/build_pack_sheets.py - do not edit. Objects whose picture is a stand-in from the packs (see the tool\'s MAP):',
             ...
             'namespace AlloyClient.Game.Components.Admin;', '', 'public static class ArtPlaceholders {', '    public static readonly string[] Names = [']
